...
return [
    ...
    'input' => [
        ...
        'currency' => 'Devise',
        'amount' => 'Montant',
        'amount_placeholder' => 'Saisissez un montant',
    ...
    'your_contact_number' => 'Votre numéro de téléphone',
    'company_name' => 'Nom de l\'entreprise',
    'your_company_or_organization' => 'Votre entreprise ou organisation',
    'address' => 'Adresse',
    'address_details' => 'Détails de l\'adresse',
    'update_password' => 'Mettez à jour le mot de passe de votre compte',
    ...
    'manage_active_sessions' => 'Gérez vos sessions actives',
    'session' => 'Session',
    'status' => 'Statut',
    'push_subscription_status' => 'Statut de votre abonnement aux notifications push',
    'transaction_id_na' => 'Aucun ID de transaction',
    'no_payment_gateways_available' => 'Aucune passerelle de paiement disponible.',
    'invalid_payment_gateway' => 'La passerelle de paiement sélectionnée est invalide.',
    'recent_transactions_description' => 'Consultez vos transactions de paiement récentes',
