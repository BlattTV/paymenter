...
return [
    ...
    'two_factor_authentication_disable_description' => 'Tem a certeza de que pretende desativar a autenticação de dois fatores? Isto removerá a camada extra de segurança da sua conta.',
    ...
    'input' => [
        ...
        'currency' => 'Moeda',
        'amount' => 'Quantidade',
        'amount_placeholder' => 'Introduza um valor',
    ...
    'manage_personal_details' => 'Faça a gestão dos seus dados pessoais',
    'name' => 'Nome',
    'your_full_name' => 'O seu nome completo',
    'email_address' => 'Endereço de e-mail',
    'your_email_address' => 'O seu endereço de e-mail',
    'phone_number' => 'Número de telefone',
    'your_contact_number' => 'O seu número de contacto',
    'company_name' => 'Nome da empresa',
    'your_company_or_organization' => 'A sua empresa ou organização',
    'address' => 'Morada',
    'address_details' => 'Detalhes da morada',
    'update_password' => 'Atualize a palavra-passe da sua conta',
    'confirm_new_password' => 'Confirme a sua nova palavra-passe',
    'your_new_password' => 'A sua nova palavra-passe',
    'add_extra_security' => 'Adicione uma camada extra de segurança à sua conta',
    'manage_active_sessions' => 'Faça a gestão das suas sessões ativas',
    'session' => 'Sessão',
    'status' => 'Estado',
    'push_subscription_status' => 'Estado da sua subscrição de notificações push',
    'transaction_id_na' => 'Sem ID de transação',
    'no_payment_gateways_available' => 'Não há gateways de pagamento disponíveis.',
    'invalid_payment_gateway' => 'O gateway de pagamento selecionado é inválido.',
    'recent_transactions_description' => 'Veja as suas transações de pagamento recentes',
