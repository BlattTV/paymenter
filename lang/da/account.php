...
return [
    ...
    'input' => [
        ...
        'currency' => 'Valuta',
        'amount' => 'Beløb',
        'amount_placeholder' => 'Indtast et beløb',
    ...
    'manage_personal_details' => 'Administrer dine personlige oplysninger',
    'name' => 'Navn',
    'your_full_name' => 'Dit fulde navn',
    'email_address' => 'E-mailadresse',
    'your_email_address' => 'Din e-mailadresse',
    'phone_number' => 'Telefonnummer',
    'your_contact_number' => 'Dit kontaktnummer',
    'company_name' => 'Firmanavn',
    'your_company_or_organization' => 'Din virksomhed eller organisation',
    'address' => 'Adresse',
    'address_details' => 'Adresseoplysninger',
    'update_password' => 'Opdater adgangskoden til din konto',
    'confirm_new_password' => 'Bekræft din nye adgangskode',
    'your_new_password' => 'Din nye adgangskode',
    'add_extra_security' => 'Tilføj et ekstra sikkerhedslag til din konto',
    'manage_active_sessions' => 'Administrer dine aktive sessioner',
    'session' => 'Session',
    'status' => 'Status',
    'push_subscription_status' => 'Status for dit push-notifikationsabonnement',
    'transaction_id_na' => 'Intet transaktions-id',
    'no_payment_gateways_available' => 'Ingen betalingsgateways tilgængelige.',
    'invalid_payment_gateway' => 'Den valgte betalingsgateway er ugyldig.',
    'recent_transactions_description' => 'Se dine seneste betalingstransaktioner',
