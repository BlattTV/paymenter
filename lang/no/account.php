...
return [
    ...
    'input' => [
        ...
        'currency' => 'Valuta',
        'amount' => 'Beløp',
        'amount_placeholder' => 'Skriv inn et beløp',
    ...
    'manage_personal_details' => 'Administrer dine personlige opplysninger',
    'name' => 'Navn',
    ...
    'your_company_or_organization' => 'Ditt firma eller din organisasjon',
    'address' => 'Adresse',
    'address_details' => 'Adresseopplysninger',
    'update_password' => 'Oppdater passordet for kontoen din',
    'confirm_new_password' => 'Bekreft det nye passordet ditt',
    'your_new_password' => 'Ditt nye passord',
    'add_extra_security' => 'Legg til et ekstra sikkerhetslag for kontoen din',
    'manage_active_sessions' => 'Administrer dine aktive økter',
    'session' => 'Økt',
    'status' => 'Status',
    'push_subscription_status' => 'Status for ditt push-varselabonnement',
    'transaction_id_na' => 'Ingen transaksjons-id',
    'no_payment_gateways_available' => 'Ingen betalingsløsninger tilgjengelig.',
    'invalid_payment_gateway' => 'Den valgte betalingsløsningen er ugyldig.',
    'recent_transactions_description' => 'Se dine siste betalingstransaksjoner',
