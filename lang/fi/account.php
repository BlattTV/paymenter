...
return [
    ...
    'manage_personal_details' => 'Hallitse henkilötietojasi',
    'name' => 'Nimi',
    'your_full_name' => 'Koko nimesi',
    'email_address' => 'Sähköpostiosoite',
    'your_email_address' => 'Sähköpostiosoitteesi',
    'phone_number' => 'Puhelinnumero',
    'your_contact_number' => 'Yhteysnumerosi',
    'company_name' => 'Yrityksen nimi',
    'your_company_or_organization' => 'Yrityksesi tai organisaatiosi',
    'address' => 'Osoite',
    'address_details' => 'Osoitetiedot',
    'update_password' => 'Päivitä tilisi salasana',
    'confirm_new_password' => 'Vahvista uusi salasanasi',
    'your_new_password' => 'Uusi salasanasi',
    'add_extra_security' => 'Lisää tilillesi ylimääräinen suojaustaso',
    'manage_active_sessions' => 'Hallitse aktiivisia istuntojasi',
    'session' => 'Istunto',
    'status' => 'Tila',
    'push_subscription_status' => 'Push-ilmoitustilauksesi tila',
    'transaction_id_na' => 'Ei tapahtumatunnusta',
    'no_payment_gateways_available' => 'Maksutapoja ei ole saatavilla.',
    'invalid_payment_gateway' => 'Valittu maksutapa on virheellinen.',
    'recent_transactions_description' => 'Katso viimeisimmät maksutapahtumasi',
    'paid_via' => ':amount palvelulla :gateway',
];
