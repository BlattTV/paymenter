...
>
    <button 
        ...
        class="relative w-full min-h-[38px] py-2 pl-3 pr-10 text-left bg-background border border-neutral rounded-xl shadow-sm cursor-pointer text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-neutral-800"
        type="button"
    >
    ...
    >
        <template x-for="item in selectableItems" :key="item.value">
            <li
                ...
                class="relative py-2 pl-8 pr-4 cursor-pointer select-none hover:bg-primary/10 text-primary-100"
            >
                <span 
